              ...
              children: <Widget>[
                ...
                InkWell(
                  child: const SettingContainer(
                    ...
                    hint: 'Personal information', orientation: 1,
                  ),
                  onTap: () {
                ...
                InkWell(
                  child: const SettingContainer(
                    ...
                    hint: 'Change Password', orientation: 1,
                  ),
                  onTap: () {
                ...
                InkWell(
                  child: const SettingContainer(
                    ...
                    hint: 'Feedback & Support', orientation: 1,
                  ),
                  onTap: () {},
                ),
                InkWell(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                InkWell(
                  child: const SettingContainer(
                    icon: Icons.account_circle,
                    hint: 'Personal information', orientation: 2,
                  ),
                  onTap: () {
                    //nextScreen(context, const ProfileCustome());
                ...
                InkWell(
                  child: const SettingContainer(
                    icon: Icons.password_outlined,
                    hint: 'Change Password', orientation: 2,
                  ),
                  onTap: () {
                    if (sp.provider == "GOOGLE" || sp.provider == "PHONE") {
                      openSnackbar(context, "Change password is invalid", Colors.red);
                ...
                InkWell(
                  child: const SettingContainer(
                    icon: Icons.feed_rounded,
                    hint: 'Feedback & Support', orientation: 2,
                  ),
                  onTap: () {},
                ),
                InkWell(
